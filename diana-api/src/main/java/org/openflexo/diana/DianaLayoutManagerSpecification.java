...
@Imports({ @Import(GridLayoutManagerSpecification.class), @Import(OutlineLayoutManagerSpecification.class),
		...
		@Import(BorderLayoutManagerSpecification.class), @Import(GridBagLayoutManagerSpecification.class),
		@Import(WrapFlowLayoutManagerSpecification.class), @Import(GraphBasedLayoutManagerSpecification.class),
...
public interface DianaLayoutManagerSpecification<LM extends DianaLayoutManager<?, ?>> extends DianaObject, Bindable {
	...
	/**
	 * Exhaustive list of all available {@link DianaLayoutManagerSpecification}
	 * 
	 * @author sylvain
	 */
	public static enum LayoutManagerSpecificationType {
		NONE {
			@Override
			public Class<DianaLayoutManagerSpecification<?>> getLayoutManagerSpecificationClass() {
				return null;
			}
		...
		BOX {
			@Override
			public Class<BoxLayoutManagerSpecification> getLayoutManagerSpecificationClass() {
				return BoxLayoutManagerSpecification.class;
			}
		...
		GRIDBAG {
			@Override
			public Class<GridBagLayoutManagerSpecification> getLayoutManagerSpecificationClass() {
				return GridBagLayoutManagerSpecification.class;
			}
		...
		WRAP_FLOW {
			@Override
			public Class<WrapFlowLayoutManagerSpecification> getLayoutManagerSpecificationClass() {
				return WrapFlowLayoutManagerSpecification.class;
			}
		...
		public abstract Class<? extends DianaLayoutManagerSpecification<?>> getLayoutManagerSpecificationClass();
	...
	@PropertyIdentifier(type = DianaModelFactory.class)
	...
	public static GRProperty<String> IDENTIFIER = GRProperty.getGRParameter(DianaLayoutManagerSpecification.class, IDENTIFIER_KEY,
			String.class);
	public static GRProperty<Boolean> PAINT_DECORATION = GRProperty.getGRParameter(DianaLayoutManagerSpecification.class,
			PAINT_DECORATION_KEY, Boolean.class);
	public static GRProperty<DraggingMode> DRAGGING_MODE = GRProperty.getGRParameter(DianaLayoutManagerSpecification.class, DRAGGING_MODE_KEY,
			DraggingMode.class);
	public static GRProperty<Boolean> ANIMATE_LAYOUT = GRProperty.getGRParameter(DianaLayoutManagerSpecification.class, ANIMATE_LAYOUT_KEY,
			Boolean.class);
	public static GRProperty<Integer> ANIMATION_STEPS_NUMBER = GRProperty.getGRParameter(DianaLayoutManagerSpecification.class,
	...
	/**
	 * Return {@link DianaModelFactory} to use when creating new layout manager conform to this specification
	 */
	@Override
	...
	/**
	 * Sets {@link DianaModelFactory} to use when creating new layout manager conform to this specification
	 */
	@Override
	@Setter(FACTORY)
	public void setFactory(DianaModelFactory aFactory);
	...
	/**
	 * Build and return a new {@link DianaLayoutManager} conform to this {@link DianaLayoutManagerSpecification}
	 * 
	 * @param containerNode
	 * @return
	 */
