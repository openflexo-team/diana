...
public interface DianaConnectorGraphics extends DianaGraphics {

	public abstract ConnectorGraphicalRepresentation getGraphicalRepresentation();

	public DianaSymbolGraphics getSymbolGraphics();
	 ...
	 *            in radians
	 */
	public abstract void drawSymbol(DianaPoint point, ConnectorSymbol symbol, double size, double angle);
