 ...
 */
public class DianaDiscreteFunction<T> extends DianaFunction<T> {

	public DianaDiscreteFunction(String functionName, Class<T> functionType, DataBinding<T> functionExpression, DianaGraphType graphType,
			DianaGraph graph) {
		super(functionName, functionType, functionExpression, graphType, graph);
	}

	/*@Override
	protected <X> List<org.openflexo.diana.graph.DianaFunction.FunctionSample<X, T>> retrieveSamples(DianaSingleParameteredGraph<X> graph) {
