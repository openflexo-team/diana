...
public abstract class DianaSingleParameteredGraph<P> extends DianaGraph {
	...
	public DianaSingleParameteredGraph() {
		super();
	}
	...
	public final void setParameter(String parameterName, Type parameterType) {
		...
		if (parameterTypes.size() > 0) {
			throw new IllegalArgumentException("DianaSingleParameteredGraph could not have more than one parameter: existing parameter "
