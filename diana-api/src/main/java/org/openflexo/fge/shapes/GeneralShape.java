...
public interface GeneralShape extends ShapeSpecification {
	...
	public static GRProperty<FGEPoint> START_POINT = GRProperty.getGRParameter(GeneralShape.class, START_POINT_KEY, FGEPoint.class);
	...
	public void setStartPoint(FGEPoint point);
	...
	public static interface GeneralShapePathElement extends FGEObject {
	}
	...
	public static interface QuadCurvePathElement extends GeneralShapePathElement {
		...
		@XMLAttribute
		public FGEPoint getControlPoint();

		@Setter(CONTROL_POINT_KEY)
		public void setControlPoint(FGEPoint point);
	...
	public static interface CubicCurvePathElement extends GeneralShapePathElement {
		...
		@XMLAttribute
		public FGEPoint getControlPoint1();

		@Setter(CONTROL_POINT_1_KEY)
		public void setControlPoint1(FGEPoint point);

		@Getter(value = CONTROL_POINT_2_KEY, isStringConvertable = true)
		@XMLAttribute
		public FGEPoint getControlPoint2();

		@Setter(CONTROL_POINT_2_KEY)
		public void setControlPoint2(FGEPoint point);
