...
public interface ForceDirectedGraphLayoutManagerSpecification extends FGELayoutManagerSpecification<ForceDirectedGraphLayoutManager> {
	...
	public static final String FORCE_MULTIPLIER_KEY = "horizontalAlignment";
	@PropertyIdentifier(type = Integer.class)
