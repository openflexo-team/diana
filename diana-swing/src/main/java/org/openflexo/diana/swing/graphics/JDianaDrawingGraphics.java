...
public class JDianaDrawingGraphics extends JDianaGraphics implements DianaDrawingGraphics {

	private static final Logger logger = Logger.getLogger(JDianaDrawingGraphics.class.getPackage().getName());

	private JDianaDrawingDecorationGraphics drawingDecorationGraphics;

	public <O> JDianaDrawingGraphics(RootNode<O> rootNode, JDrawingView<O> view) {
		super(rootNode, view);
		drawingDecorationGraphics = new JDianaDrawingDecorationGraphics(rootNode, view);
	}
	...
	@Override
	public DianaDrawingDecorationGraphics getDrawingDecorationGraphics() {
