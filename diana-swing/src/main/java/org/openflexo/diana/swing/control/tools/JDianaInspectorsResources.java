...
public class JDianaInspectorsResources {
	...
	public static String SHADOW_NAME = FGECoreUtils.DIANA_LOCALIZATION.localizedForKey("shadow");

	public static Resource BACKGROUND_STYLE_FIB_FILE = ResourceLocator.locateResource("Fib/BackgroundStylePanel.fib");
	public static String BACKGROUND_NAME = FGECoreUtils.DIANA_LOCALIZATION.localizedForKey("background");

	public static Resource SHAPE_SPECIFICATION_PANEL_FIB_FILE = ResourceLocator.locateResource("Fib/ShapeSelectorPanel.fib");
	public static String SHAPE_NAME = FGECoreUtils.DIANA_LOCALIZATION.localizedForKey("shape");
	...
	public static String CONNECTOR_NAME = FGECoreUtils.DIANA_LOCALIZATION.localizedForKey("connector");

	public static Resource LOCATION_SIZE_FIB_FILE = ResourceLocator.locateResource("Fib/LocationSizePanel.fib");
	public static String LOCATION_NAME = FGECoreUtils.DIANA_LOCALIZATION.localizedForKey("location_size");

	public static Resource LAYOUT_MANAGERS_FIB_FILE = ResourceLocator.locateResource("Fib/LayoutManagersPanel.fib");
	public static String LAYOUT_NAME = FGECoreUtils.DIANA_LOCALIZATION.localizedForKey("layout_managers");
}
