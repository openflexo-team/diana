 ...
 * 
 */
public class ExampleDianaDiscretePolarFunctionGraphDrawing extends DrawingImpl<Object> {

	private DianaDiscretePolarFunctionGraph<SimplePerson> graph;
	...
	public ExampleDianaDiscretePolarFunctionGraphDrawing(Object obj, DianaModelFactory factory) {
	...
	public void init() {
		...
		graph = new DianaDiscretePolarFunctionGraph<>();
		...
		weightFunction = graph.addNumericFunction("weight", Double.class, new DataBinding<Double>("person.weight"), DianaGraphType.BAR_GRAPH);
