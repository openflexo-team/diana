...
public abstract class AbstractTestDianaGraph {
	...
	private static final Logger logger = FlexoLogger.getLogger(AbstractTestDianaGraph.class.getPackage().getName());

	protected static SwingGraphicalContextDelegate gcDelegate;

	protected static DianaModelFactory factory = null;
	...
	final ExampleDianaContinuousFunctionGraphDrawing d = makeExampleDrawing1();
	...
	final ExampleDianaDiscreteFunctionGraphDrawing d2 = makeExampleDrawing2();
