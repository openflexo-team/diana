...
public class VaadinToolFactory implements DianaToolFactory<AbstractComponent> {
	...
	public static final VaadinToolFactory DEFAULT = new VaadinToolFactory(null);
	
	private LayoutPanel layoutpanel;
	
	public VaadinToolFactory(LayoutPanel layoutpanel){
		System.out.println("pb not in VaadinToolFac");
		this.layoutpanel = layoutpanel;
	}
	
	@Override
	public DianaToolSelector<? extends AbstractComponent, ?> makeDianaToolSelector(
	...
	@Override
	public DianaScaleSelector<? extends AbstractComponent, ?> makeDianaScaleSelector(
			AbstractDianaEditor<?, ?, ?> editor) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public DianaPalette<? extends AbstractComponent, ?> makeDianaPalette(
			DrawingPalette palette) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public DrawPolygonToolController<?> makeDrawPolygonToolController(
			DianaInteractiveEditor<?, ?, ?> controller, DrawShapeAction control) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public DrawComplexCurveToolController<?> makeDrawClosedCurveToolController(
			DianaInteractiveEditor<?, ?, ?> controller,
	...
	@Override
	public DrawShapeToolController<?> makeDrawShapeToolController(
			DianaInteractiveEditor<?, ?, ?> controller, DrawShapeAction control) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public DrawConnectorToolController<?> makeDrawConnectorToolController(
			DianaInteractiveEditor<?, ?, ?> controller,
	...
	@Override
	public DrawTextToolController<?> makeDrawTextToolController(
			DianaInteractiveEditor<?, ?, ?> controller, DrawShapeAction control) {
		// TODO Auto-generated method stub
		return null;
	}
