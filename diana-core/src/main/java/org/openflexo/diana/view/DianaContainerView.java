...
/**
 * Implemented by all views representing a DrawingTreeNode and which can contains some other DianaView<br>
 ...
 */
public interface DianaContainerView<O, C> extends DianaView<O, C> {

	public void addView(DianaView<?, ?> view);

	public void removeView(DianaView<?, ?> view);

	public <RC> List<DianaView<?, ? extends RC>> getChildViews();
}
