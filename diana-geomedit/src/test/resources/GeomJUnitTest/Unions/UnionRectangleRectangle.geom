...
<GeometricDiagram id="0" name="UnionRectangleRectangle.geom">
  <RectangleWithTwoPointsConstruction id="1" name="Rectangle0">
    ...
    <RectangleGraphicalRepresentation id="6" identifier="680facfd">
  ...
  <UnionConstruction id="15" mergeContents="false" name="Union2">
    ...
    <ObjectReference id="17" name="Construction8">
      <RectangleWithTwoPointsConstruction idref="8" />
    </ObjectReference>
    ...
    <ComputedAreaGraphicalRepresentation id="20" identifier="4a34561c">
      <TextStyle id="21" backgroundColor="255,255,255" color="0,0,0" font="Lucida Sans,0,11" />
    </ComputedAreaGraphicalRepresentation>
  </UnionConstruction>
  <DrawingGraphicalRepresentation id="22" backgroundColor="255,255,255" drawWorkingArea="false" focusColor="255,0,0" selectionColor="0,0,255" rectangleSelectingSelectionColor="0,0,255" dimensionConstraints="FREELY_RESIZABLE" identifier="78e84310">
