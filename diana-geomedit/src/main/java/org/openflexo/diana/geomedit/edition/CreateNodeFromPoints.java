...
public class CreateNodeFromPoints extends Edition {

	public CreateNodeFromPoints(GeomEditDrawingController controller) {
		super("Create node from points", controller);
	...
	public void performEdition() {
		...
		addConstruction(getController().getFactory().makeNodeWithTwoPointsConstruction(p1.getConstruction(), p2.getConstruction()));
