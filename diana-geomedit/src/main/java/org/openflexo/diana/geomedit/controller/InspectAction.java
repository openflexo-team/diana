...
public class InspectAction extends AbstractEditorActionImpl {
	...
	public InspectAction(GeomEditDrawingController anEditorController) {
		super("inspect", GeomEditIconLibrary.INSPECT_ICON, anEditorController);
	}
	...
	public GeometricConstruction<?> performAction(GeometricConstruction<?> object) {
		JFIBDialogInspectorController inspector = getEditorController().getEditor().getApplication().getConstructionInspector();
		if (inspector != null)
