...
public class CopyAction extends AbstractEditorActionImpl {
	...
	public static KeyStroke ACCELERATOR = KeyStroke.getKeyStroke(KeyEvent.VK_C, GeomEditApplication.META_MASK);

	public CopyAction(GeomEditDrawingController anEditorController) {
		super("copy", GeomEditIconLibrary.COPY_ICON, anEditorController);
	}
