...
public class GeomEditPreferences {

	private static final String GEOM_EDIT = "GeomEdit";
	...
	private static final Preferences prefs = Preferences.userRoot().node(GEOM_EDIT);
