 ...
 * 
 */
public class NodeShapeSpecificationFactory extends ShapeSpecificationFactory {

	private static final Logger logger = Logger.getLogger(NodeShapeSpecificationFactory.class.getPackage().getName());

	public NodeShapeSpecificationFactory(GeomEditDrawingController controller) {
		super(controller);
	}
